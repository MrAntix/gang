...
export declare type GangEvents = IGangAuthenticatedHostEvent | IGangAuthenticatedMemberEvent | IGangAccessDeniedEvent | IGangMemberConnectedEvent | IGangMemberDisconnectedEvent | IGangCommandEvent | IGangCommandReceiptEvent | IGangStateEvent;
